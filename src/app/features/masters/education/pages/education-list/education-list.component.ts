...
export class EducationListComponent implements OnInit, OnDestroy {
  ...
  hasPermission(permission: string): boolean {
    ...
    return this.rbacService.hasPermission(permissionMap[permission]);
  }

  navigateToAdd(): void {
    this.router.navigate(['/masters/educations/add']);
  }

  navigateToEdit(education: Education): void {
    this.router.navigate(['/masters/educations/edit', education.id]);
  }
