import { Component, OnInit, OnDestroy, ChangeDetectorRef, signal, ViewChild } from '@angular/core';
...
export class CourseListComponent implements OnInit, OnDestroy {
  ...
  navigateToAdd(): void {
    this.router.navigate(['/masters/courses/add']);
  }

  navigateToEdit(course: Course): void {
    this.router.navigate(['/masters/courses/edit', course.id]);
  }
